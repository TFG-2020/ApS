...
Debido a la complejidad de la nueva base de datos compuesta por 46 tablas relacionales, se ha decidido crear un diagrama relacional que sirva como mapa en la gestión de la base de datos.\\\\
...
Y la última es la sección que tiene menos complejidad, la sección de Comunicación que contiene las tablas de mail, mensaje, upload y newsletter, estas creadas por David que se han mantenido intactas.\\\\
\subsubsection{Sección Usuarios}
...
Debido a esta separación todos los usuarios comparten una tabla común llamada usuario que contiene datos exclusivos de la cuenta de la plataforma. Despues tenemos tablas que contienen datos particulares de cada tipo de usuario, estas son las tablas de entidad, estudiante interno, estudiante externo, admin, profesor interno, profesor externo y oficina ApS.\\
...
Despues podemos observar tablas secundarias que representan caracteristicas de los usuarios como es la universidad del profesor y estudiante interno, los Areas de Conocimiento UNESCO de los profesores y las titulaciones que imparten los profesores o cursan los alumnos.\\\\
\subsubsection{Sección Anuncios de servicio}
